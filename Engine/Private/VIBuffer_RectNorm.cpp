...
CVIBuffer_RectNorm* CVIBuffer_RectNorm::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CVIBuffer_RectNorm* pInstance = new CVIBuffer_RectNorm(pDevice, pContext);
...
CComponent* CVIBuffer_RectNorm::Clone(void* pArg)
{
	CVIBuffer_RectNorm* pInstance = new CVIBuffer_RectNorm(*this);
