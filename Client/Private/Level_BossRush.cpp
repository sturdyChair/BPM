...
#include "..\Public\Level_BossRush.h"
#include "UIBase.h"
...
CLevel_BossRush::CLevel_BossRush(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CLevel{ pDevice, pContext }
{

}

HRESULT CLevel_BossRush::Initialize()
{
	m_iLevelID = LEVEL_BOSSRUSH;
	...
	CRoomManager::Get_Instance()->Start(LEVEL_BOSSRUSH);
...
void CLevel_BossRush::Tick(_float fTimeDelta)
{
	if (GetFocus())
		SetCursorPos(g_iWinSizeX / 2, g_iWinSizeY / 2);
}

HRESULT CLevel_BossRush::Render()
{
...
HRESULT CLevel_BossRush::Ready_Layer_Camera(const wstring& strLayerTag)
{
...
HRESULT CLevel_BossRush::Ready_Layer_BackGround(const wstring& strLayerTag)
{
...
HRESULT CLevel_BossRush::Ready_Layer_Effect(const wstring& strLayerTag)
{
...
HRESULT CLevel_BossRush::Ready_Layer_UI(const wstring& strLayerTag)
{
...
HRESULT CLevel_BossRush::Ready_LandObjects()
{
...
CLevel_BossRush* CLevel_BossRush::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CLevel_BossRush* pInstance = new CLevel_BossRush(pDevice, pContext);

	if (FAILED(pInstance->Initialize()))
	{
		MSG_BOX(TEXT("Failed to Created : CLevel_BossRush"));
