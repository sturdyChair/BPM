...
class CEffect_Spike :public CEffectObject
{
public:
...
private:
    CEffect_Spike(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CEffect_Spike(const CEffect_Spike& rhs);
    virtual ~CEffect_Spike() = default;
public:
...
public:
    static  CEffect_Spike* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
