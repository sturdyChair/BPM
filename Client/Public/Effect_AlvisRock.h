...
class CEffect_AlvisRock :public CEffectObject
{
public:
...
private:
    CEffect_AlvisRock(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CEffect_AlvisRock(const CEffect_AlvisRock& rhs);
    virtual ~CEffect_AlvisRock() = default;
public:
...
public:
    static  CEffect_AlvisRock* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, _uint iFrag);
