...
class CEffect_RuneSpear :public CEffectObject
{
public:
...
private:
    CEffect_RuneSpear(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CEffect_RuneSpear(const CEffect_RuneSpear& rhs);
    virtual ~CEffect_RuneSpear() = default;
public:
...
public:
    static  CEffect_RuneSpear* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
