...
BEGIN(Client)
class CMonster_Demon : public CMonster_Base
{
public:
	enum STATE
	{
...
private:
	CMonster_Demon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMonster_Demon(const CMonster_Demon& rhs);
...
public:
	static CMonster_Demon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
