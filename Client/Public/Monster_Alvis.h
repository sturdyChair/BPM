...
class CUI_BossHP;
class CTrail;
class CMonster_Alvis : public CMonster_Base
{
public:
	enum STATE
	{
...
private:
	CMonster_Alvis(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMonster_Alvis(const CMonster_Alvis& rhs);
	virtual ~CMonster_Alvis() = default;
...
public:
	static CMonster_Alvis* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
