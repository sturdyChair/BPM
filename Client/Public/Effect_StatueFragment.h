...
class CEffect_StatueFragment :public CEffectObject
{
public:
...
private:
    CEffect_StatueFragment(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CEffect_StatueFragment(const CEffect_StatueFragment& rhs);
    virtual ~CEffect_StatueFragment() = default;
public:
...
private:
    ...
    _uint m_iFrag = 0;
public:
    static  CEffect_StatueFragment* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, _uint iFrag);
