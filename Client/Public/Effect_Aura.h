...
class CEffect_Aura :public CEffectObject
{
public:
...
private:
    CEffect_Aura(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CEffect_Aura(const CEffect_Aura& rhs);
    virtual ~CEffect_Aura() = default;
public:
...
public:
    static  CEffect_Aura* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
