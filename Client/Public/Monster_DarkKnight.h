...
class CMonster_DarkKnight : public CMonster_Base
{
public:
	enum STATE
	{
...
private:
	CMonster_DarkKnight(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMonster_DarkKnight(const CMonster_DarkKnight& rhs);
	virtual ~CMonster_DarkKnight() = default;
...
public:
	static CMonster_DarkKnight* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
