...
class CTrail;
class CEffect_Teardrop :public CEffectObject
{
public:
...
private:
    CEffect_Teardrop(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CEffect_Teardrop(const CEffect_Teardrop& rhs);
    virtual ~CEffect_Teardrop() = default;
public:
...
public:
    static  CEffect_Teardrop* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
