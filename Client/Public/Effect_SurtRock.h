...
class CEffect_SurtRock :public CEffectObject
{
public:
...
private:
    CEffect_SurtRock(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CEffect_SurtRock(const CEffect_SurtRock& rhs);
    virtual ~CEffect_SurtRock() = default;
public:
...
public:
    static  CEffect_SurtRock* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
