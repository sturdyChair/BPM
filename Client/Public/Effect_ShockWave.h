...
class CTrail;
class CEffect_ShockWave :public CEffectObject
{
public:
...
private:
    CEffect_ShockWave(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CEffect_ShockWave(const CEffect_ShockWave& rhs);
...
public:
    static  CEffect_ShockWave* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
