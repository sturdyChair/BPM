...
class CEffect_Fragment :public CEffectObject
{
public:
...
private:
    CEffect_Fragment(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CEffect_Fragment(const CEffect_Fragment& rhs);
    virtual ~CEffect_Fragment() = default;
public:
...
public:
    static  CEffect_Fragment* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
